      ...
      <AnimatePresence>
        {showMatch && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-background/90 backdrop-blur-xl px-8"
          >
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
            ...
            <div className="flex gap-4 mb-8">
              <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-love-pink">
                <img
                  src={showMatch.photos?.[0] || "/placeholder.jpg"}
                  alt=""
          ...
          >
            <div className="relative w-full h-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-5 pt-20">
                ...
                {currentProfile.city && (
                  <p className="text-white/60 text-sm flex items-center gap-1 mb-2">
