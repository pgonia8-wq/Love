...
export default function SwipePage({ userId, isPremium }: SwipePageProps) {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <div className="flex-1 relative min-h-0 flex items-center justify-center px-4 py-2">
        <AnimatePresence mode="popLayout">
          <motion.div
            ...
            className="w-full h-full max-w-sm rounded-3xl overflow-hidden shadow-2xl cursor-grab active:cursor-grabbing"
          >
            <div className="relative w-full h-full">
              ...
              <motion.div
                ...
                className="absolute top-8 left-6 border-4 border-green-500 rounded-xl px-4 py-2 rotate-[-15deg]"
              >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-4 pt-16">
                ...
                {currentProfile.city && (
                  <p className="text-white/60 text-sm flex items-center gap-1 mb-1.5">
      ...
      <div className="flex-shrink-0 flex items-center justify-center gap-5 py-3 px-4">
        {isPremium && canUndo && (
          <motion.button
            whileTap={{ scale: 0.85 }}
            onClick={() => handleUndo(isPremium)}
            className="w-12 h-12 rounded-full bg-card border border-border/50 flex items-center justify-center shadow-md"
          >
        ...
        <motion.button
          ...
          className="w-16 h-16 rounded-full bg-card border border-border/50 flex items-center justify-center shadow-lg"
        >
        ...
        <motion.button
          ...
          disabled={isProcessing}
          className="w-16 h-16 rounded-full gradient-love flex items-center justify-center shadow-lg animate-pulse-glow"
        >
